...
const Addmore = () => {
  ...
  const handeleAddMore = () => {
    setUserList([
      ...userList,
      { id: userList.length + 1, fname: "", lname: "", country: "" },
    ]);
      ...
      <div className='container px-5'>
        ...
        {userList?.map((item, index) => (
          <div className='row' key={index}>
            <div className='col-2'>
              <label forname='fname' className='d-block'>
                first name
              </label>
              <input
            ...
            <div className='col-2'>
              <label forname='lname' className='d-block'>
                Last name
              </label>
              <input
                className='form-control'
            ...
            <div className='col-2'>
              ...
              {index !== 0 && (
                <>
                  <label forname='fname' className='d-block v-hidden'>
                    Action
                  </label>
                </>
              )}
