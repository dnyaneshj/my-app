    ...
    return (
      <>
        <form onSubmit={this.submitHandler}>
          <input
            type='text'
            value={this.state.dataIbject.fname}
            onChange={this.nameChaneHandler}
            placeholder='fname'
          />
          <input
            type='text'
            value={this.state.dataIbject.lname}
            onChange={this.lnamesChaneHandler}
            placeholder='lname'
          />
          <input
            type='text'
            value={this.state.dataIbject.address}
            onChange={this.addressChaneHandler}
            placeholder='address'
          />
          <input
            type='text'
            value={this.state.dataIbject.picode}
            onChange={this.picodeChaneHandler}
            placeholder='pincode'
          />
          <button type='subnit'>submit</button>
          <h2>
            {this.state.payLoad.fname} {this.state.payLoad.lname}{" "}
            {this.state.payLoad.address} {this.state.payLoad.picode}
          </h2>
        </form>
